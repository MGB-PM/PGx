...
if __name__ == '__main__':
	...
	for workflow in test_codes:
		...
		if workflow == 'pgx':
			...
			gene_phenotypes, extra_genes_variants = pgx_utils._diplotypes_to_phenotypes(genotyping_report, config['pgx']['gene_annotations_dir'], config['pgx']['genes_without_annotations'])
			if args.do_pgx_CPIC:
